...
ActiveRecord::Schema[7.0].define(version: 2024_02_02_155706) do
  ...
  create_table "ticket_bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["show_time_id"], name: "index_ticket_bookings_on_show_time_id"
  ...
  add_foreign_key "ticket_bookings", "show_times"
